...
namespace MMMEngine {
	...
	public:
		std::filesystem::path Serialize(Material* _in, std::wstring _path, std::wstring _name, int _index);		// _path는 출력path
		void DeSerialize(Material* _out, std::wstring _path);		// _path는 입력path
	};
}
